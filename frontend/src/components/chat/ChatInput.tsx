...
type Props = {
  ...
  onSend: () => void;
  onStudyMaterialUpload?: (files: FileList) => void;
};

export const ChatInput = ({ value, onChange, onSend, onStudyMaterialUpload }: Props) => {
    ...
    <div className="bg-[#1C1C1C] flex-shrink-0 px-2 pb-2">
      <div className="w-full overflow-hidden border border-[#76746F] rounded-2xl">
        <div className="relative bg-[#272725]">
          {/* Hidden file input for study material uploads */}
          <input
        ...
        <div className="flex items-center justify-between bg-[#272725] px-3 py-2">
          ...
          <Button
            ...
            className="flex items-center gap-1 h-8 px-3 text-xs font-medium bg-[#1E52F1] hover:bg-[#1E52F1]/90 text-white rounded-lg"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              disabled={!value.trim()}
              size="icon"
              className="h-8 w-8 rounded-full bg-[#1E52F1] hover:bg-[#1E52F1]/90 disabled:bg-gray-600"
            >
